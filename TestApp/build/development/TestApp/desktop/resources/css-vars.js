...
__rt_setDynamic("$base-invisible-color", __rt_getGlobalDefault("$base_invisible_color") || __rt_box(__rt.registered.rgba.apply(__rt.registered, __rt_applySpreadArgs([
    ...
    __udf, 
    __udf]))), 9);
__rt_setDynamic("$base-foreground-color", __rt_getGlobalDefault("$base_foreground_color") || __rt_get("$base_light_color"), 10);
__rt_setDynamic("$accent-color", __rt_getGlobalDefault("$accent_color") || __ColorRGBA.fromHex("#e7bd3b"), 11);
__rt_setDynamic("$accent-light-color", __rt_getGlobalDefault("$accent_light_color") || __ColorRGBA.fromHex("#58ce8b"), 12);
__rt_setDynamic("$accent-dark-color", __rt_getGlobalDefault("$accent_dark_color") || __ColorRGBA.fromHex("#101010"), 13);
...
__rt_setDynamic("$reverse-background-color", __rt_getGlobalDefault("$reverse_background_color") || __ColorRGBA.fromHex("#d06b3e"), 35);
